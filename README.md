...
* Create boxplot for different features and identify the outlier values. Then remove the outliers from the dataset to remove noise.
* Again, I was only able to achieve 73%
